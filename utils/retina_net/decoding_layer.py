...
from utils.retina_net.retina_output import *
...
class DecodePredictions(tf.keras.layers.Layer):
    ...
    def call(self, images, predictions):
        ...
        nms_box, nms_cls = tf.map_fn(nms, (boxes, cls_predictions), dtype=(tf.float32, tf.float32), 
...
class OldDecodePredictions(tf.keras.layers.Layer):
    """A Keras layer that decodes predictions of the RetinaNet model.
